...
![article-embed-half](/articles/physics-engine/sphere-plane.svg)
![article-embed-half](/articles/physics-engine/sphere-sphere.svg)
...
Then we can stub out the different interactions we will support. I will include a Sphere vs Sphere and Sphere vs Plane test. I won’t go into the math behind these in this article, but you can find the code [here](https://github.com/IainWinter/IwEngine/blob/3e2052855fea85718b7a499a7b1a3befd49d812b/IwEngine/include/iw/physics/impl/TestCollision.h#L25). 
...
In the last section the meat was in the design, this one leans much more towards what kinds of solvers you implement. I've made an impulse & position solver myself that seem to work for most situations. To keep this short, I won't cover the math here, but you can check out the source for the impulse solver [here](https://github.com/IainWinter/IwEngine/blob/3e2052855fea85718b7a499a7b1a3befd49d812b/IwEngine/src/physics/Dynamics/ImpulseSolver.cpp), and the position solver [here](https://github.com/IainWinter/IwEngine/blob/3e2052855fea85718b7a499a7b1a3befd49d812b/IwEngine/src/physics/Dynamics/SmoothPositionSolver.cpp) if you are interested.
