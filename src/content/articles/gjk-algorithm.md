...
thumbnail: thumbnails/MDusDn8oTSE.jpg
date: August 29, 2020
---
...
[iframe](gjk-algorithm/app/circles.html)
...
[iframe](gjk-algorithm/app/sub_poly.html)
...
[iframe](gjk-algorithm/app/mink_diff.html)
...
[img](gjk-algorithm/supports.jpg)
...
Let's look at the implementation -- I'm going to continue to use the Collider structs from the [link](physics engine, physics-engine) article for consistency, but will only include the new pieces from this article.
...
[iframe](gjk-algorithm/app/slide-show.html)
...
[img](gjk-algorithm/triangle.jpg)
...
[img](gjk-algorithm/tetrahedron.jpg)
...
Here is a demo that will let you play around with the algorithm and let you inspect each iteration, here's the [link](full version, gjk-algorithm/app/demo.html) if you want a better look...

[iframe](gjk-algorithm/app/demo.html)